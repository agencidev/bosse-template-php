    ...
    <div class="container">
        ...
        <div class="grid">
            ...
            <a href="/categories" class="card">
                <?php
                $_cat_count = 0;
                $_cat_file_path = __DIR__ . '/extensions/categories.php';
                if (file_exists($_cat_file_path)) {
                    $_cat_data = require $_cat_file_path;
                    if (is_array($_cat_data)) $_cat_count = count($_cat_data);
                }
                if ($_cat_count > 0): ?>
                <span class="badge"><?php echo $_cat_count; ?></span>
                <?php endif; ?>
                <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <span class="label">Kategorisidor</span>
            </a>
