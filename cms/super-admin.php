...
<body>
                    ...
                    <div style="margin-top: 1rem;">
                        ...
                        <div style="display:flex;gap:0.5rem;">
                            <div style="position:relative;flex:1;">
                                <input type="password" id="new-customer-password" placeholder="Minst 8 tecken" style="width:100%;padding:0.5rem 2.5rem 0.5rem 0.75rem;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.15);border-radius:0.375rem;color:white;font-size:0.875rem;">
                                <button type="button" id="toggle-sa-password" style="position:absolute;right:0.5rem;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:rgba(255,255,255,0.4);padding:0.25rem;display:flex;align-items:center;" aria-label="Visa lösenord">
    ...
    var saToggle = document.getElementById('toggle-sa-password');
    if (saToggle) {
